    ...
    while True:
        ...
        if queue_item is not None:
            ...
            if execution_time > 600:
                ...
                logging.info(f"Prompt id:{prompt_id} executed in {execution_time}", extra={'color': 'green'})
            else:
                logging.info(f"Prompt id:{prompt_id} executed in {execution_time:.2f} seconds", extra={'color': 'green'})
